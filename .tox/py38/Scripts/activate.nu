...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Tobias\PycharmProjects\robotic-arm-for-chess\.tox\py38'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Tobias\PycharmProjects\robotic-arm-for-chess\.tox\py38\Scripts\deactivate.nu'
